...
## การตรวจตัวเลขและรายการซ้ำ

[ตัวเลขต้องทวน](audit_details/numeric_review.csv) และ [รายการซ้ำ](audit_details/duplicate_review.csv) เก็บครบโดยไม่เลือกค่าหรือลบต้นฉบับ; ดู [flag ต่างจากกรอบวันที่](tables/lockdown_date_review.csv) สำหรับข้อจำกัดนิยาม
