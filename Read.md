...
# Insight เพิ่มเติมนอกประเด็น COVID (กราฟ 17–20)
...
![](outputs/traffic_patterns/figures/17_daily_profile.png)
...
![](outputs/traffic_patterns/figures/18_location_vehicle_mix.png)
...
![](outputs/traffic_patterns/figures/19_road_concentration.png)
...
![](outputs/traffic_patterns/figures/20_sampling_priority.png)
...
ตารางเต็มและชื่อสถานที่อยู่ใน [outputs/traffic_patterns](outputs/traffic_patterns/) ออกแบบด้วยกราฟมาตรฐานใน [Matplotlib Gallery](https://matplotlib.org/stable/gallery/)
